...
\par \textit{Handling of Three-address-code (TAC) Instructions:}  These instructions (like, e.g. \texttt{add, cmp, mul etc)} are supported by SMT solvers. So their translation is straightforward.
